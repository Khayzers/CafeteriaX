                    ...
                    <div class="card border-0 shadow-sm h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('dueno.cafeterias.edit', $cafeteria->id) }}" class="btn btn-gold btn-sm flex-fill">
                                    <i class="fas fa-edit me-1"></i>Editar
                                </a>
                                <a href="{{ route('dueno.menu.index', $cafeteria->id) }}" class="btn btn-outline-gold btn-sm flex-fill">
                                    <i class="fas fa-utensils me-1"></i>Menú
                                </a>
                                <a href="#" class="btn btn-outline-gold btn-sm flex-fill">
