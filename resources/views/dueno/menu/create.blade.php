...
@section('title', 'Nuevo Item - ' . $cafeteria->name)
                ...
                <div class="card card-elegant">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="mb-0">
                                <i class="fas fa-plus-circle text-gold me-2"></i>Nuevo Item del Menú
                            </h2>
                        ...
                        <form action="{{ route('dueno.menu.store', $cafeteria->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row g-3 mb-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control form-control-elegant" id="preparation_time" name="preparation_time" 
                                           value="{{ old('preparation_time', 5) }}" min="0">
                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" 
                                                           ...
                                                           {{ in_array($alergeno, old('allergens', [])) ? 'checked' : '' }}>
